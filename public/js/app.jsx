            ...
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between py-4">
                    ...
                    <div className="logo-container">
                        <img src="/api/logo" alt="GIE Logo" className="logo-image" onError={(e) => {
...
// Certificate Display Component matching the exact format
const CertificateDisplay = ({ certificate, onClose }) => {
    ...
    return (
        <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 modern-section">
            <div className="container mx-auto px-4">
                <div className="certificate-result mx-auto">
                    <div className="p-8 gie-bg-orange text-white rounded-t-2xl">
                        <div className="flex justify-between items-center">
                            <h3 className="text-3xl font-bold">Certificate Report</h3>
                            <div className="flex items-center space-x-4">
                                <span className="bg-green-500 px-4 py-2 rounded-full text-sm font-bold shadow-lg">
                                    <i className="fas fa-shield-check mr-2"></i>VERIFIED
                                </span>
                                {onClose && (
                                    <button 
                                        onClick={onClose} 
                    ...
                    <div className="bg-white rounded-b-2xl overflow-hidden">
                        {fields.map((field, index) => (
                            <div key={index} className="cert-field">
                                <div className="cert-label">{field.label}</div>
                                <div className="cert-value">{field.value}</div>
                            </div>
                        ))}
                        
                        {certificate.imageUrl && (
                            <div className="cert-field">
                                <div className="cert-label">GEM IMAGE:</div>
                                <div className="cert-value">
                                    <img 
                                        src={certificate.imageUrl} 
                                        alt="Gemstone" 
                                        className="max-w-52 max-h-52 object-contain border-2 border-gray-200 rounded-lg shadow-md"
                                    />
                                </div>
                            </div>
                        )}
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-wrap items-center">
                        <div className="w-full lg:w-1/2 mb-8 lg:mb-0">
                            <img src="/api/gemstone" alt="Gemstone Collection" className="w-full h-auto rounded-lg shadow-lg" onError={(e) => {
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-wrap items-center">
                        ...
                        <div className="w-full lg:w-1/2">
                            <img src="/api/gem-test" alt="Gem Testing Equipment" className="w-full h-auto rounded-lg shadow-lg" onError={(e) => {
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="mt-12 text-center">
                            <img src="/api/gem-test" alt="Gem Testing Equipment" className="w-full max-w-2xl mx-auto rounded-lg shadow-lg" onError={(e) => {
                                e.target.src = 'data:image/svg+xml;base64,';
                            }}/>
                        </div>
                    </div>
